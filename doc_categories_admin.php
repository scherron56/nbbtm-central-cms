                        ...
                        $.each(res.categories, function(i, c) {
                            ...
                            $tbody.append(`
                                <tr>
                                    ...
                                    <td><span style="text-transform: capitalize;">${escapeHtml(c.entity_type)}</span></td>
  ...
  <div class="admin-wrapper">
        ...
        <form id="categoryForm">
            ...
            <div class="form-row" style="display: flex; gap: 15px; margin-bottom: 10px;">
                ...
                <div class="form-group" style="flex: 2;">
                    ...
                    <input type="text" id="category_name" name="category_name" placeholder="e.g. Planning Packet, Facility Layout, Waiver" class="form-control" required>
                </div>
            </div>

            <div class="form-group" style="margin-bottom: 10px;">
                <label for="description">Description (Optional):</label>
                <input type="text" id="description" name="description" placeholder="Brief note explaining category usage" class="form-control">
            </div>
    ...
    <div class="card">
        <div class="filter-row">
            ...
            <div>
                <label for="filter_entity">Filter by Scope: </label>
