...
try {
    switch ($action) {
        ...
        // --- FETCH CONTACTS LOOKUP (Sorted & Formatted as Last Name, First Name) ---
        ...
        case 'save_event':
            ...
            if (empty($id)) {
                ...
                // Delete old schedules and budgets
                ...
                // Clear previous ministry support records
            ...
            // Sync Checked Ministries into prg_evnt_min_support
            ...
            $db->commit();
            echo json_encode(['success' => true, 'message' => 'Event details and support assignments saved successfully!', 'prg_evnt_id' => $id]);
            break;
