...
$(document).ready(function() {
  ...
  // Load Sessions into top dropdown
  ...
  // Load classes dropdown based on vbs_sessions_id
  ...
  // Load contacts into student select field
  function loadStudentDropdown() {
    $.ajax({
      ...
      error: function(jqXHR, textStatus) {
        console.error("Failed to load contacts:", textStatus);
      }
    });
  }

  // Fetch VBS Roster Table
  function loadRoster() {
