...
// Fetch all valid contacts with their membership and age categories
$contactsList = [];
try {
...
$verifiedSenders = [
    'revtdsublett@claricecraftedsolutions.org'   => 'NBBTM Office',
    'nbbtmadmin@claricecraftedsolutions.org' => 'Pastoral Staff',
    'nbbtmtest@claricecraftedsolutions.org' => 'Programs & Events Team'
    'nbbtmtestclaricecraftedsolutions.org' => 'Programs & Events Team'
    ];
...
function filterContacts() {
  ...
  allContacts.forEach(contact => {
    ...
    option.textContent = `${contact.full_name || 'No Name'} (${contact.c_email}) - ${isMember ? 'Member' : 'Non-Member'}, ${isChild ? 'Child' : 'Adult'}`;
