...
.logo-container img.scaled-svg { width: 65px; height: 65px; object-fit: contain; }
...
.modal-content h3 { margin-top: 0; margin-bottom: 1rem; border-bottom: 2px solid #e2e8f0; padding-bottom: 0.5rem; }
.modal-close { position: absolute; top: 10px; right: 15px; background: none; border: none; font-size: 1.5rem; font-weight: bold; color: #64748b; cursor: pointer; }
.modal-close:hover { color: #dc2626; }
.password-wrapper { position: relative; display: flex; align-items: center; }
.toggle-password-btn { position: absolute; right: 8px; background: none; border: none; cursor: pointer; font-size: 1rem; padding: 0; opacity: 0.7; transition: opacity 0.2s ease; }
.toggle-password-btn:hover { opacity: 1; }
.text-success { color: #16a34a !important; font-size: 0.85rem; }
