...
<head>
  ...
  <script>
    $(document).ready(function() {
        ...
        // Toggle Option A / Option B and refresh sign-offs
        ...
        // 1. Load Contacts & Populate Dropdown (Formatted as Last Name, First Name)
                ...
                success: function(data) {
                    if(data.success && data.contacts) {
                        ...
                        $.each(contactsCache, function(i, c) {
                            ...
                            $cSelect.append(`<option value="${c.contact_id}">${escapeHtml(displayName)}</option>`);
                        });
        ...
        // Auto-fill phone and email on contact selection
        ...
        // 2. Load Ministries and Target Support Ministries
        ...
        // 3. Dynamically Populate Sign-offs for Checked Affected Ministries (Optional Checkboxes)
        function refreshSignoffCheckboxes() {
            let $container = $('#dynamicMinistrySignoffs');
            
            // Preserve current checked state before rebuilding
            let checkedIds = [];
        ...
        // Submit Event Form (No required blocks for sign-offs)
        ...
        <?php if ($canEdit): ?>
            <form id="eventForm" enctype="multipart/form-data">
                ...
                <fieldset class="dashboard-main-grid fieldset-relative">
                    ...
                    <!-- ACKNOWLEDGEMENT & AUTHORIZATION SIGN-OFFS (OPTIONAL) -->
                    <div class="field-group" id="acknowledgementSection" style="--colspan: 2;">
                        ...
                        <div class="auth-box">
                            ...
                            <!-- Affected Ministries Sign-offs (Populated dynamically) -->
